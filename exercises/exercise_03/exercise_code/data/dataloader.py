...
class DataLoader:
    ...
    def batch_to_numpy(self, qbatch):
        numpy_batch = {}
    ...
    def __iter__(self):
        ...
        for index in index_iterator:  # iterate over indices using the iterator
            ...
            if len(batch) == self.batch_size:
                ...
                batch = []
            if progress_indicator == len(self.dataset)-1 and not self.drop_last and len(batch) != 0:
                yield self.batch_to_numpy(self.combine_batch_dicts(batch))
                batch = []
        ########################################################################
        #                           END OF YOUR CODE                           #
    ...
    def __len__(self):
        ...
        if not self.drop_last and len(self.dataset)%self.batch_size != 0: length = length+1
